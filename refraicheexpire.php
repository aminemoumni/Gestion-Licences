...
if (isset($_GET['search'])) 
  $req = "select IdLicence, NomClient, LibelleProduit, LibelleTypeLicence, Garantie, DateDebut, DateFin, NomAgent, PrenomAgent, NomEnregistrement, NomContactClient, Numerodeserie
    ...
    <table class="table table-striped custab text-center">
      ...
      echo "<tr>
        ...
        "</td>
         ...
         <td class='text-center'><a class='btn btn-info btn-xs' href='plusinfo.php?id=$dat->IdLicence'><span class='glyphicon glyphicon-edit'></span>Plus Info</a> <a class='btn btn-warning btn-xs' href='modifierlic.php?id=$dat->IdLicence'><span class='glyphicon glyphicon-edit'></span>Modifier</a>  </td> </tr>"
        ?>
          <tbody id="result">
