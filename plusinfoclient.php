  ...
  <div class="container" style="padding-top: 1%; padding-left: 5%;">
    ...
    <p style="font-size: 1.1em; color:black"><b>Source Image:</b></p>
       ...
       <div class="form-group col">   
        ...
        <div style="padding-bottom: 2%; text-align: right;">
        <a class='btn btn-info btn-xs' href='filter.php?page=<?php echo($_GET['page']);?>'><span class='glyphicon glyphicon-edit'></span>Retour à la liste</a>
         </div> 
