  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <!-- Begin Page Content -->
<div style="margin-top: 15%;" class="text-center" tabindex="-1"  aria-hidden="true">
  <div class="modal-dialog " role="document">
    <div class="modal-content " style="text-align:center;">
      <div class="modal-header ">
        <h5 class="modal-title " style="text-align: center;"id="exampleModalLabel">Création de trace suite à une modification </h5>
...
if(strpos($fullUrl, "enregistre=success") == true) {
  echo "<h4  style='text-align:center;' class='succes'>Le trace est bien enregistre</h4>";
}
      ...
      <div class="modal-footer text-center"  >
       ...
       <a href="acceuil.php"> <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
       <a href="licencetraceph.php?id=<?php echo($_GET['id']); ?>"> <button type="button" class="btn btn-warning">Créer trace avant modification</button></a>
       <a href="modifierlic.php?id=<?php echo($_GET['id']); ?>"> <button type="button" class="btn btn-danger">Modifier</button></a> 
   <?php } if (isset($_GET['enregistre'])) {
   	
   
   ?>
       <a href="modifierlic.php?id=<?php echo($_GET['id']); ?>"> <button type="button" style="margin-right: 2px; "  class="btn btn-success ">Modifier</button></a> 
   <?php } ?>
      </div>
    </div>
  </div>
