  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <div class="container" style="min-height: 100px; margin-top: 12%;">
			<div class="main">
				<div class="main-center">
					
					
				<h3 class="deb3">Ajouter un nouveau produit.</h3>
					<form class="" method="get" action="ajouterproduitph.php">

						<div class="form-group">
			 				<label for="Nom de License">Designation produit</label>
								<div class="input-group">
				          <input type="text" class="form-control" name="DesignationProduit" id="prenom"  placeholder="Designation Produit"/>
							</div>
						</div>
...
elseif(strpos($fullUrl, "enregistre=success") == true) {
	...
	echo "<h4 class='success'>Votre Produit " . ucwords($_GET['LibelleProduit']) . "  Est Bien Enregistre</h4>";
}
