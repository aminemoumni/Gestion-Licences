...
<?php 
$requete4 = "select * from agent where IdAgent =" . $_GET['id'] . "";
...
?>
      ...
      <div class="main">
        ...
        <h3 class="deb3">Modifier l'agent <?php echo ($key->NomAgent); echo" "; echo ($key->PrenomAgent); ?>.</h3>
          <form class="" method="get" action="modifierlesagentph.php">
            <input type="hidden" name="id" value="<?php echo ($key->IdAgent); ?>">
          <div class="form-row ">
            <div class="form-group col">
              ...
              <label for="Votre Nom">Votre nom</label>
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="nom" value="<?php echo ($key->NomAgent);?>" placeholder="Votre Nom"/>
                </div>
            </div>

            <div class="form-group col">
              <label for="Nom de License">Votre prenom</label>
                <div class="input-group">
                  <input type="text" class="form-control" value="<?php echo ($key->PrenomAgent);?>" name="prenom" id="prenom"  placeholder="Votre Prenom"/>
              </div>
            </div>
          </div>
            <div class="form-group ">
              <label for="entreprise">Téléphone</label>
                <div class="input-group">
                  <input type="phone" class="form-control" value="<?php echo ($key->TelAgent)?>" name="tel" placeholder="Telephone"/>
              </div>
            </div>

            <div class="form-group">
              <label for="La Date de Début">Email</label>
                <div class="input-group">
                  <input type="email" class="form-control" value="<?php echo ($key->EmailAgent);?>" name="email" placeholder="Email"/>
                </div>
            </div>

            <div class="form-group">
              <label for="La Date de Fin">Mot de passe</label>
                <div class="input-group">
                  
                  <input type="PasswordAgent" class="form-control"  name="pass" placeholder="Mot De Passe"/>
                </div>
            </div>

            <div class="form-group">
              <label for="La Date de Fin">Confirmer mot de passe</label>
                <div class="input-group">
                  
                  <input type="PasswordAgent" class="form-control" name="Cpass" placeholder="Confirmer Mot De Passe"/>
                </div>
            </div>
            <div class="btn">
        <button class="btn btn-lg btn-success"  type="submit">Modfier</button> 
...
elseif(strpos($fullUrl, "enregistre=pass") == true) {
  echo "<h6 class='errorempty'> les Mot De Passe Sont Pas Les Meme </h4>";
}
...
elseif(strpos($fullUrl, "enregistre=success") == true) {
  ...
  echo "<h4 class='success'>Votre Information Est Bien Modifier</h4>";
}
