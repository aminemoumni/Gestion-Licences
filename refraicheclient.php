...
if (isset($_GET['search'])) 
  $req = "select * from client where NomClient LIKE '" . $_GET['search'] . "'";
     ...
     <table class="table table-striped custab text-center">
      ...
      echo "<tr>
        ...
        "</td> 
         ...
         <td class='text-center'> <a class='btn btn-warning btn-xs' href='modifierclient.php?id=$dat->IdClient'><span class='glyphicon glyphicon-edit'></span>Modifier</a> <a class='btn btn-danger' href='supprimerclient.php?id=$dat->IdClient'><span class='glyphicon glyphicon-edit'></span>Supprimer</a> </td> </tr>";
         ?>
          <tbody id="result">
