    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <!-- Topbar Search -->
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="get" action="refraichetype.php">
            <div class="input-group">
              <input style=" display: block;" type="text" name="search" id="search" id="dropdownMenuButton" class="form-control bg-light border-0 small" placeholder="Recherche Type Licence..." aria-label="Search" aria-describedby="basic-addon2">
...
if(strpos($fullUrl, "suppression=valid") == true) {
  echo "<h6  style='text-align:center; color: red;' class='errorempty'>La Type Licence Est Supprimer</h6>";
}
if(strpos($fullUrl, "suppression=echec") == true) {
    echo "<h6 style='text-align:center;' class='errorempty'> Impossible de supprimer </h6>";
}
...
if(strpos($fullUrl, "enregi=succes") == true) {
  echo "<h6  class='success' style='text-align:center;'>La type licence est bien enregistre</h6>";
}
           ?>
</div>
    <div style="padding-top: 1%;" class="custyle">
      <div style="text-align: bottom; margin-bottom: -4%;">
      <a class="btn btn-info btn-xs" href="ajoutertypelicence.php"><span class='glyphicon glyphicon-edit'></span>Ajouter Type Licence</a></div>
    <table class="table table-striped custab text-center">
    
        <tr>
            
            <th class='tr1' >Type Licence</th>

            <th class="text-center">Action</th>
        </tr>
   
              <?php  
                $requete1 = "select * from typelicence order by IdTypeLicence DESC";
...
$affi = $resu->fetchAll(PDO::FETCH_OBJ);
      ...
      echo "<tr>
        ...
        <td class='tr1'>"
           . $dat->LibelleTypeLicence .
        "</td>
        
         <td class='text-center'> <a class='btn btn-danger' data-target='#examplModal' href='supprimertypelicence.php?id=$dat->IdTypeLicence'><span class='glyphicon glyphicon-edit'></span>Supprimer</a> </td> </tr>"
        ?>
