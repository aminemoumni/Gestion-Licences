  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="main">
        ...
        <h3 class="deb3">Modifier Votre Information.</h3>
          <form class="" method="get" action="modifier.php">
          <div class="form-row ">
            <div class="form-group col">
              ...
              <label for="Votre Nom">Votre nom</label>
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="nom" value="<?php echo ($_SESSION['NomAgent']);?>" placeholder="Votre Nom"/>
                </div>
            </div>

            <div class="form-group col">
              <label for="Nom de License">Votre prénom</label>
                <div class="input-group">
                  <input type="text" class="form-control" value="<?php echo ($_SESSION['PrenomAgent']);?>" name="prenom" id="prenom"  placeholder="Votre Prenom"/>
              </div>
            </div>
          </div>
            <div class="form-group ">
              <label for="entreprise">Téléphone</label>
                <div class="input-group">
                  <input type="phone" class="form-control" value="<?php echo ($_SESSION['TelAgent']);?>" name="tel" placeholder="Telephone"/>
              </div>
            </div>
            ...
            <div class="form-group">
              <label for="La Date de Début">Email</label>
                <div class="input-group">
                  <input type="email" class="form-control" value="<?php echo ($_SESSION['EmailAgent']);?>" name="email" placeholder="Email"/>
                </div>
            </div>
