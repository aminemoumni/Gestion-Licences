...
$limit = 10;
               ...
               $start = ($page - 1) * $limit;
               $requettt = "SELECT count(IdLicence) as idli FROM licence  Where Validation = 'Expire'";
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <!-- Topbar Search -->
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="get" action="refraicheexpire.php">
            <div class="input-group">
              <input style=" display: block;" type="text" name="search" id="search" id="dropdownMenuButton" class="form-control bg-light border-0 small" placeholder="Recherche Licence Expire..." aria-label="Search" aria-describedby="basic-addon2">
...
if (isset($_GET['page'])) {
               ...
               $page = $_GET['page']; } 
          $req = "select IdLicence, NomClient, DesignationProduit, LibelleTypeLicence, Garantie, DateDebut, DateFin, NomAgent, PrenomAgent, NomEnregistrement, NomContactClient, Numerodeserie
from licence NATURAL JOIN agent NATURAL JOIN client NATURAL JOIN contactclient NATURAL JOIN produit NATURAL JOIN typelicence Where Validation = 'Expire' order by DateFin DESC LIMIT $start,$limit";
$resu = $pdo->query($req);
...
if(strpos($fullUrl, "suppression=valid") == true) {
  echo "<h6  style='text-align:center; color: red;' class='errorempty'>Supprimer</h6>";
}
...
if(strpos($fullUrl, "sup=clean") == true) {
  echo "<h6  class='success' style='text-align:center;'>Toutes Les Licenses Sont Active</h6>";
    ...
    <div style="padding-top: 0%;" class="custyle">
    <table class="table table-striped custab text-center">
      ...
      echo "<tr>
        ...
        "</td>
         ...
         <td class='text-center'><a class='btn btn-info btn-xs' href='plusinfoexpire.php?id=$dat->IdLicence&page=$page'><span class='glyphicon glyphicon-edit'></span>Plus Info</a> <a class='btn btn-warning btn-xs' href='modifierlic.php?id=$dat->IdLicence'><span class='glyphicon glyphicon-edit'></span>Modifier</a>  </td> </tr>"
        ?>
          <tbody id="result">
  ...
  <ul class="pagination">
    <li class="page-item"><a class="page-link" href="licenceexpire.php?&page=<?php echo($p); ?>">Précedent</a></li>
   <?php for($i = 1; $i <= $pages; $i++) : ?>
            <li class="page-item"><a class="page-link" href="licenceexpire.php?&page=<?php echo($i); ?>"><?php echo($i); ?></a></li>
            <?php endfor; ?>
   
    <li class="page-item"><a class="page-link" href="licenceexpire.php?page=<?php echo($s); ?>">Suivant</a></li>
  </ul>
</nav>
</div>     
                    </div>
