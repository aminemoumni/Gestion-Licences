  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="main">
        ...
        <h3 class="deb3">Ajouter Une Type Licence.</h3>
          <form class="" method="get" action="ajoutertypelicenceph.php">
          
            <div class="form-group">

              <label for="Votre Nom">Type Licence:</label>
                <div class="input-group">
                  
                  <input type="text" class="form-control" name="typelicence" placeholder="Type Licence"/>
                </div>
            </div>
            <div class="btn">
...
if(strpos($fullUrl, "enregistre=empty") == true) {
  echo "<h6  class='errorempty'>veuillez remplir le champ Type Licence</h6>";
}

elseif(strpos($fullUrl, "enregistre=success") == true) {

  echo "<h4 class='success'>Votre Type Licence " . ucwords($_GET['typelicence']) . "  Est Bien Enregistre</h4>";
}
