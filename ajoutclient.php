      ...
      <div class="modal-footer">
        ...
        <div class="container" style="min-height: 100px; margin-top: 5%;">
			<div class="main">
				...
				<h3 class="deb3">Ajouter un nouveau client.</h3>
					<form class="" method="get" action="ajouterclientph.php">
          
						<div class="form-group">

							<label for="Votre Nom">Nom client</label> <label for="entreprise" class="errorempty"> * </label>
								<div class="input-group">
									
									<input type="text" class="form-control" name="nomclient" placeholder="Nom Client"/>
								</div>
						</div>

						<div class="form-group">
			 				<label for="Nom de License">Adresse client</label> <label for="entreprise" class="errorempty"> * </label>
								<div class="input-group">
				          <input type="text" class="form-control" name="adresse" id="prenom"  placeholder="Adresse Client"/>
							</div>
						</div>
          
						<div class="form-group ">
							<label for="entreprise">Télephone</label>
								<div class="input-group">
...
elseif(strpos($fullUrl, "enregistre=success") == true) {
	...
	echo "<h6 class='success'>Votre Client " . ucwords($_GET['nomclient']) . "  Est Bien Enregistre</h6>";
}
