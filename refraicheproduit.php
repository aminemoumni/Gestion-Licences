...
if (isset($_GET['search'])) 
  $req = "select * from produit where LibelleProduit LIKE '%" . $_GET['search'] . "%'";
    ...
    <table class="table table-striped custab text-center">
      ...
      echo "<tr>
        ...
        "</td>
         ...
         <td class='text-center'> <a class='btn btn-danger' href='supprimerproduit.php?id=$dat->IdProduit'><span class='glyphicon glyphicon-edit'></span>Supprimer</a> </td> </tr>"
        ?>
          <tbody id="result">
