    ...
    <table class="table table-striped custab text-center">
      ...
      echo "<tr>
        ...
        "</td>
         ...
         <td class='text-center'><a class='btn btn-info btn-xs' href='plusinfo.php?id=$dat->IdLicence'><span class='glyphicon glyphicon-edit'></span>Plus Info</a> <a class='btn btn-warning btn-xs' href='modifierlic.php?id=$dat->IdLicence'><span class='glyphicon glyphicon-edit'></span>Modifier</a> <a class='btn btn-danger' href='supprimerconfirm.php?id=$dat->IdLicence'><span class='glyphicon glyphicon-edit'></span>Supprimer</a> </td> </tr>"
        ?>
