...
if(strpos($fullUrl, "sup=clean") == true) {
 ...
 $limit = 10;
               ...
               $start = ($page - 1) * $limit;
               $requettt = "SELECT count(IdLicence) as idli FROM licence";
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist" style="margin-bottom: -4%; margin-top: 5%;">
                                <li class="nav-item">
                                    <a class="nav-link" href="acceuil.php?email=<?php echo($_SESSION['EmailAgent']);?>&pass=<?php echo($_SESSION['PasswordAgent']);?>">Filtrer par Récent Ajouter</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active"  href="#recent" id="home-tab" data-toggle="tab" role="tab" aria-controls="home">Filtrer par Client</a>
                                </li>
                                <li class="nav-item">
...
$affi = $resu->fetchAll(PDO::FETCH_OBJ);
      ...
      echo "<tr>
        ...
        "</td>
         ...
         <td class='text-center'><a class='btn btn-info btn-xs' href='plusinfoclient.php?id=$dat->IdLicence&page=$page'><span class='glyphicon glyphicon-edit'></span>Plus Info</a> <a class='btn btn-warning btn-xs' href='licencetracemodifier.php?id=$dat->IdLicence'><span class='glyphicon glyphicon-edit'></span>Modifier</a> <a class='btn btn-danger' href='supprimerconfirm.php?id=$dat->IdLicence'><span class='glyphicon glyphicon-edit'></span>Supprimer</a> </td> </tr>"
        ?>
        </table>
  ...
  <ul class="pagination">
    <li class="page-item"><a class="page-link" href="filter.php?page=<?php echo($p); ?>">Previous</a></li>
   <?php for($i = 1; $i < $pages; $i++) : ?>
            <li class="page-item"><a class="page-link" href="filter.php?page=<?php echo($i); ?>"><?php echo($i); ?></a></li>
            <?php endfor; ?>
   
    <li class="page-item"><a class="page-link" href="filter.php?page=<?php echo($s); ?>">Next</a></li>
  </ul>
</nav>
