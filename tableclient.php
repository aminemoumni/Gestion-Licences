    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <!-- Topbar Search -->
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="get" action="refraicheclient.php">
            <div class="input-group">
              <input style=" display: block;" type="text" name="search" id="search" id="dropdownMenuButton" class="form-control bg-light border-0 small" placeholder="Recherche Client..." aria-label="Search" aria-describedby="basic-addon2">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <?php 
          ...
          $req = "select * from client order by IdClient DESC";
$resu = $pdo->query($req);
...
if(strpos($fullUrl, "suppression=valid") == true) {
  echo "<h6  style='text-align:center; color: red;' class='errorempty'>Le client Est bien supprimer</h6>";
}
if(strpos($fullUrl, "suppression=echec") == true) {
    echo "<h6 style='text-align:center;' class='errorempty'> Impossible de supprimer le cient</h6>";
}
if(strpos($fullUrl, "Erreur=correcte") == true) {
    echo "<h6 style='text-align:center;' class='success'> Verifier Votre Boite Email</h6>";
}
if(strpos($fullUrl, "enregi=success") == true) {
  echo "<h6 style='text-align:center;' class='success'>Le Client est bien modifier</h6>";
}
if(strpos($fullUrl, "sup=clean") == true) {
  echo "<h6  class='success' style='text-align:center;'>Toutes Les Licenses Sont Active</h6>";
    ...
    <div style="padding-top: 1%;" class="custyle">
      ...
      <a class="btn btn-info btn-xs" href="ajoutclient.php"><span class='glyphicon glyphicon-edit'></span>Ajouter client</a>
      <a class="btn btn-info btn-xs" href="ajoutcontactclient.php"><span class='glyphicon glyphicon-edit'></span>Ajouter contact client</a>
      <a style="float: right;" class="btn btn-info btn-xs" href="ajoutlicence.php"><span class='glyphicon glyphicon-edit'></span>Ajouter licence</a>
    </div>
    <table class="table table-striped custab text-center">
    
        <tr>
            <th class='tr1' >Nom Client</th>
            <th class='tr1' >Adresse Client</th>
            <th class='tr1'>Téléphone Client </th>
            <th class='tr1' >Email Client </th>
      ...
      echo "<tr>
        ...
        "</td> 
         ...
         <td class='text-center'> <a class='btn btn-warning btn-xs' href='modifierclient.php?id=$dat->IdClient'><span class='glyphicon glyphicon-edit'></span>Modifier</a> <a class='btn btn-danger' href='supclientconfi.php?id=$dat->IdClient'><span class='glyphicon glyphicon-edit'></span>Supprimer</a> </td> </tr>";
         ?>
          <tbody id="result">
