...
if(strpos($fullUrl, "sup=clean") == true) {
 ...
 $limit = 10;
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist" style="margin-bottom: -4%; margin-top: 5%;">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active"  href="#recent" id="home-tab" data-toggle="tab" role="tab" aria-controls="profile">Filtrer par Produit</a>
                                </li>
...
from licence NATURAL JOIN agent NATURAL JOIN client NATURAL JOIN contactclient NATURAL JOIN produit NATURAL JOIN typelicence Where Validation = 'Active' order by DesignationProduit LIMIT $start,$limit";
...
$affi = $resu->fetchAll(PDO::FETCH_OBJ);
      ...
      echo "<tr>
        ...
        "</td>
         ...
         <td class='text-center'><a class='btn btn-info btn-xs' href='plusinfoproduit.php?id=$dat->IdLicence&page=$page'><span class='glyphicon glyphicon-edit'></span>Plus Info</a> <a class='btn btn-warning btn-xs' href='licencetracemodifier.php?id=$dat->IdLicence'><span class='glyphicon glyphicon-edit'></span>Modifier</a> <a class='btn btn-danger' href='supprimerconfirm.php?id=$dat->IdLicence'><span class='glyphicon glyphicon-edit'></span>Supprimer</a> </td> </tr>"
        ?>
        </table>
                            </div>
  ...
  <ul class="pagination">
    <li class="page-item"><a class="page-link" href="produit.php?page=<?php echo($p); ?>">Précedent</a></li>
   <?php for($i = 1; $i <= $pages; $i++) : ?>
            <li class="page-item"><a class="page-link" href="produit.php?page=<?php echo($i); ?>"><?php echo($i); ?></a></li>
            <?php endfor; ?>
   
    <li class="page-item"><a class="page-link" href="produit.php?page=<?php echo($s); ?>">Suivant</a></li>
  </ul>
</nav>
</div>
       </div> 
