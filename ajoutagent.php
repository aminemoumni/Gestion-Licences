      ...
      <div class="modal-footer">
        ...
        <div class="container" style="min-height: 100px; margin-top: 4%;">
			<div class="main">
				...
				<h3 class="deb3">Ajouter un nouveau agent.</h3>
					<form class="" method="get" action="ajouter.php">
          <div class="form-row ">
						<div class="form-group col">

							<label for="Votre Nom">Votre nom</label><label for="entreprise" class="errorempty"> * </label>
								<div class="input-group">
						...
						<div class="form-group col">
			 				<label for="Nom de License">Votre prénom</label><label for="entreprise" class="errorempty"> * </label>
								<div class="input-group">
						...
						<div class="form-group ">
							<label for="entreprise">Télephone</label><label for="entreprise" class="errorempty"> * </label>
								<div class="input-group">
									<input type="phone" class="form-control" name="tel" placeholder="Telephone"/>
							</div>
						</div>

						<div class="form-group">
							<label for="La Date de Début">Email</label><label for="entreprise" class="errorempty"> * </label>
								<div class="input-group">
						...
						<div class="form-group">
							<label for="La Date de Fin">Mot de passe</label><label for="entreprise" class="errorempty"> * </label>
								<div class="input-group">
						...
						<div class="form-group">
							<label for="La Date de Fin">Confirmer mot de passe</label><label for="entreprise" class="errorempty"> * </label>
								<div class="input-group">
...
elseif(strpos($fullUrl, "enregistre=success") == true) {
	...
	echo "<h4 class='success'>Votre Agent " . ucwords($_GET['nom']) . "  Est Bien Enregistre</h4>";
}
