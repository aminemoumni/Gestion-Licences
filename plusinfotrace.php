...
$pdo = NEW PDO('mysql:host=localhost;dbname=gestionlicence','root');
          $req = "select NomClient, LibelleProduit, LibelleTypeLicence, Garantie, DateDebut, DateFin, NomAgent, PrenomAgent, NomEnregistrement, ReferenceMarche, ImageLicence, Validation, NomContactClient, Numerodeserie, DateTrace
from tracelicence NATURAL JOIN agent NATURAL JOIN client NATURAL JOIN contactclient NATURAL JOIN produit NATURAL JOIN typelicence Where IdTraceLicence=" . $_GET['id'] . "";
$resu = $pdo->query($req);
...
foreach ($affi as $key ) 
  ...
  <div class="container" style="padding-top: 1%; padding-left: 5%;">
    ...
    <p style="font-size: 1.1em; color:black"><b>Source Image:</b></p>
          ...
          <div class="form-group col">
            <p style="font-size: 1.1em; color:black"><b>Date creation trace:</b></p>
            <p style="padding-left: 10%; font-family: Helvetica;"><?php echo ucwords($key->DateTrace) ;?></p>
      </div>
        </div>
        <div class="form-row ">
       <div class="form-group col">
            <p style="font-size: 1.1em; color:black"><b>Référéncé marché/BC:</b></p>
            <textarea rows="3" cols="100"><?php echo $key->ReferenceMarche ;?></textarea>
       ...
       <div class="form-group col">   
            ...
            <textarea rows="3" cols="100"><?php echo $key->Numerodeserie ;?></textarea>
           </div>
        </div> 
...
<div style="padding-bottom: 2%; text-align: left; padding-left: 11%;">
        <a class='btn btn-info btn-xs' href='admin.php?page=<?php echo($_GET['page']);?>'><span class='glyphicon glyphicon-edit'></span>Retour à la liste</a>
         </div> 
