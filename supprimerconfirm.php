...
<div style="margin-top: 2%;" class="text-center" tabindex="-1"  aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Vous Voules Vraiment Suprrimer</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
       <?php
          $req = "select NomClient, LibelleProduit, DesignationProduit, LibelleTypeLicence, Garantie, DateDebut, DateFin, NomAgent, PrenomAgent, NomEnregistrement, ReferenceMarche, ImageLicence, Validation, NomContactClient, Numerodeserie
  ...
  <div class="container" style="padding-top: 1%; padding-left: 5%;">
    <div class="custyle">
      ...
      <div class="form-group col">
        ...
        <div class="form-group col">
            ...
            <p style="font-size: 1.1em; color:black"><b>Produit:</b></p>
            <p style="padding-left: 10%;"><?php echo $key->DesignationProduit;?></p>
    ...
    <div class="form-row ">
     ...
     <div class="form-group col">
      ...
      <div class="modal-footer">
       <a href="acceuil.php"> <button type="button" class="btn btn-secondary" data-dismiss="modal">Férmer</button>
       <a href="supprimer.php?id=<?php echo($_GET['id']); ?>"> <button type="button" class="btn btn-danger">Supprimer</button></a>
      </div>
    </div>
  </div>
</div>
