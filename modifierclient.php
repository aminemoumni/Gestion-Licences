  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <!-- Begin Page Content -->
       <?php $requete4 = "select * from client where IdClient = " . $_GET['id'] . "";
  ...
  ?>      
        <div class="container" style="min-height: 100px; margin-top: 5%;">
			<div class="main">
				...
				<h3 class="deb3">Modifier Le Client <?php echo ($key->NomClient); ?>.</h3>
					<form class="" method="get" action="modifierclientph.php">
          <input type="hidden" value="<?php echo($key->IdClient); ?>" name="id">
						<div class="form-group">

							<label for="Votre Nom">Nom client</label>
								<div class="input-group">
									
									<input type="text" class="form-control" value="<?php echo($key->NomClient) ?>" name="nomclient" placeholder="Nom Client"/>
								</div>
						</div>

						<div class="form-group">
			 				<label for="Nom de License">Adresse client</label>
								<div class="input-group">
				          <input type="text" class="form-control" value="<?php echo($key->AdresseClient) ?>" name="adresse" id="prenom"  placeholder="Adresse Client"/>
							</div>
						</div>
						...
						<div class="form-group ">
							<label for="entreprise">Téléphone</label>
								<div class="input-group">
									<input type="phone" class="form-control" value="<?php echo($key->TelClient) ?>" name="tel" placeholder="Telephone"/>
							</div>
						</div>
						...
						<div class="form-group">
							<label for="La Date de Début">Email</label>
								<div class="input-group">
									<input type="email" class="form-control" value="<?php echo($key->EmailClient) ?>" name="email" placeholder="Email"/>
								</div>
						</div>
...
elseif(strpos($fullUrl, "enregistre=char") == true) {
	echo "<h6 class='errorempty'>veuillez remplir Le Nom Correctement</h6>";
}
...
elseif(strpos($fullUrl, "enregistre=success") == true) {
	...
	echo "<h4 class='success'>Votre Client " . ucwords($_GET['nomclient']) . "  Est Bien Enregistre</h4>";
}
