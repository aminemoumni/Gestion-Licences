    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <!-- Topbar Search -->
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="get" action="refraicheproduit.php">
            <div class="input-group">
              <input style=" display: block;" type="text" name="search" id="search" id="dropdownMenuButton" class="form-control bg-light border-0 small" placeholder="Recherche Produit..." aria-label="Search" aria-describedby="basic-addon2">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <?php 
          ...
          $req = "select * from produit order by IdProduit DESC";
$resu = $pdo->query($req);
...
if(strpos($fullUrl, "suppression=valid") == true) {
  echo "<h6  style='text-align:center; color: red;' class='errorempty'>Le produit est bien supprimer</h6>";
}
  ...
  echo "<h6  class='success' style='text-align:center;'>Toutes Les Licenses Sont Active</h6>";
    ...
    <table class="table table-striped custab text-center">
        ...
        <tr>
            ...
            <th class='tr1' >Designation Produit</th>
      ...
      echo "<tr>
        ...
        "</td>
         ...
         <td class='text-center'>  <a class='btn btn-danger' href='supproduitconfi.php?id=$dat->IdProduit'><span class='glyphicon glyphicon-edit'></span>Supprimer</a> </td> </tr>";
         ?>
          <tbody id="result">
