                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="profile-head">
                                    <h5>
                                        <?php echo ($_SESSION['NomAgent']);echo" "; echo ($_SESSION['PrenomAgent']); ?>
                                    </h5>
                                    <h6>
                    ...
                    <div class="col-md-2">
                      ...
                      ?>
                      <a href="modifieragent.php"> <input type="button" class="profile-edit-btn" name="btnAddMore" value="Modfier Profile"/></a>
                      
                    </div>
                    <div class="col-md-3">
                      
                      <a href="supagent.php"> <input type="button" class="profile-edit-btn" name="btnAddMore" value="Supprimer Profile"/></a> <?php } ?>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="tab-content profile-tab" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p><?php echo ($_SESSION['NomAgent']);echo" "; echo ($_SESSION['PrenomAgent']); ?></p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <p><?php echo ($_SESSION['EmailAgent']); ?></p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <p><?php if ($_SESSION['TelAgent'] == '') {
                                                  echo "Veuillez Ajouter Votre numero par click sur Modifier Profile";
                                                } else{ echo ($_SESSION['TelAgent']);} ?></p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <p><?php echo ($_SESSION['PasswordAgent']); ?></p>
                                            </div>
                                        </div>
                            </div>
