...
$requete = "select * from produit order by LibelleProduit";
$resultat = $pdo->query($requete);
$metier = $resultat->fetchAll(PDO::FETCH_OBJ);
$requete1 = "select * from typelicence Order by LibelleTypeLicence";
$resultat1 = $pdo->query($requete1);
$type = $resultat1->fetchAll(PDO::FETCH_OBJ);
$requete2 = "select * from agent Order by NomAgent";
$resultat2 = $pdo->query($requete2);
$agent = $resultat2->fetchAll(PDO::FETCH_OBJ);
$requete3 = "select * from client order by NomClient";
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <!-- Begin Page Content -->
        <div style=";" class="custyle">
      
        <div class="container" style="min-height: 100px; margin-top: 0%; margin-bottom: 1%;">
         <div style="text-align: right; margin-right: 13%;">
     
      <a  class="btn btn-info btn-xs" style="margin-bottom: 1%;" href="ajoutertypelicence.php"><span class='glyphicon glyphicon-edit'></span>Ajouter type licence</a>
    </div> 
			<div class="main" >
...
if(strpos($fullUrl, "enregistre=empty") == true) {
  echo "<h6  class='errorempty'>veuillez remplir tous les champs</h6>";
}
...
elseif(strpos($fullUrl, "enregistre=pro") == true) {
  echo "<h6 class='errorempty'> Choissiez Un Produit</h6>";
}
elseif(strpos($fullUrl, "enregistre=typ") == true) {
  echo "<h6 class='errorempty'> Choissiez Un Type Licence</h6>";
}
...
elseif(strpos($fullUrl, "enregistre=gar") == true) {
  echo "<h6 class='errorempty'> Choissiez Une Garantie</h6>";
}
elseif(strpos($fullUrl, "enregistre=success") == true) {

  echo "<h5 class='success'>Votre Licence " . ucwords($_GET['Libelle']) . "  Est Bien Enregistre</h5>";
}

?> </div>

					
				<h3 class="deb3">Ajouter une nouvelle licence.</h3>
					<form enctype="multipart/form-data" method="POST" action="ajouterlicence.php">
            <div class="form-row">
              <div class="form-group col">
              <label for="La Date de Fin">Client final </label> <label for="entreprise" class="errorempty"> * </label>
                <div class="input-group">
                  
                  <select class="form-control"  id="country" class="tg"  >
     ...
     foreach ($client as $clientt)
      ...
      ?>
              ...
              <div class="form-group col">
                ...
                <div class="input-group">
                     <a href="ajoutclient.php" style="margin-top: 10%;"> Ajouter un client </a>
              </div>
            </div>
          </div>
          <div class="form-row">
          <div class="form-group col">
              <label for="entreprise"> Contact client final </label> <label for="entreprise" class="errorempty"> * </label>
                <div class="input-group">
                  <select class="form-control" name="contact" id="state" class="tg"  >
                    <option> Select Client d'abord</option>
            ...
            <div class="form-group col">
                ...
                <div class="input-group">
                     <a href="ajoutcontactclient.php" style="margin-top: 10%;"> Ajouter un contact client </a>
              </div>
            </div>
          </div>
          <div class="form-group">
              <label for="La Date de Fin">Référénce marché/BC </label>
                <div class="input-group">
                  
                  <textarea type="text" class="form-control" name="ref" placeholder="Reference marché/BC"></textarea>
                </div>
            </div>
            <div class="form-row ">
            <div class="form-group col">
              <label for="La Date de Fin">Personne concernée </label> <label for="entreprise" class="errorempty"> * </label>
                <div class="input-group">
                  
                 <select class="form-control" name="agent" id="metiers" class="tg" id="txtville" >
                    <option> Select Un Agent</option>
     <?php  
     foreach ($agent as $data)
      ...
      ?>
            ...
            <div class="form-group col">
              <label for="La Date de Fin"></label>
                <div class="input-group">
                  
                  <a href="ajoutagent.php" style="padding-top: 8%;"> Ajouter Un Agent </a>
                </div>
            </div>
          </div>
          <div class="form-row ">
     ...
     $b = $data->LibelleProduit;
      ?>
          ...
          <div class="form-group col">
                ...
                <div class="input-group">
                     <a href="ajoutproduit.php" style="margin-top: 10%;"> Ajouter Un Produit </a>
              </div>
            </div>
           </div>
           <div class="form-row ">
				  <div class="form-group col">
			 				<label for="Nom de License">Type licence </label> <label for="entreprise" class="errorempty"> * </label>
								<div class="input-group">
				          <select class="form-control" name="type" id="metiers" class="tg" id="txtville" >
                    <option> Select Type Licence</option>
     <?php  
     foreach ($type as $typee)
      ...
      ?>
						...
						<div class="form-group col">
							<label for="entreprise">Garantie </label> <label for="entreprise" class="errorempty"> * </label>
								<div class="input-group">
                 <select class="form-control" name="garantie" id="metiers" class="tg" id="txtville" >
                    <option> Select par an</option>
           ...
           <option value="5 ans">5 ans</option>
            ...
            <div class="form-group">
              <label for="La Date de Fin">Numéro de série </label>
                <div class="input-group">
                  
                  <textarea type="text" class="form-control" name="serie" placeholder="Mettre un ; pour la séparation"></textarea>
                </div>
            </div>
            <div class="form-row ">

            <div class="form-group col">
              <label for="La Date de Début">Date début </label> <label for="entreprise" class="errorempty"> * </label>
                <div class="input-group">
                  <input type="Date" class="form-control" name="dateDebut" placeholder="Email"/>
                </div>
            </div>

            <div class="form-group col">
              <label for="La Date de Fin">Date fin </label> <label for="entreprise" class="errorempty"> * </label>
                <div class="input-group">
                  
                  <input type="date" class="form-control" name="dateFin" placeholder="Mot De Passe"/>
                </div>
            </div>
          </div>
            <div class="form-row ">
            <div class="form-group col">
              <label for="La Date de Début">Nom d'enregistrement</label>
                <div class="input-group">
                  <input type="text" class="form-control" name="NomEnregistrement" placeholder="Nom enregistrement"/>
                </div>
            </div>
          </div>
            
          <div class="form-group">
              <label for="La Date de Fin">Pièces jointes</label>
                <div class="input-group">
