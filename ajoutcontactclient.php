...
$affi = $resu->fetchAll(PDO::FETCH_OBJ);
         ...
         ?>
        <div class="container" style="min-height: 100px; margin-top: 5%;">
			<div class="main">
				<div class="main-center">
					
					
				<h3 class="deb3">Ajouter un nouveau contact client.</h3>
					<form class="" method="get" action="ajoutercontactclientph.php">
          
						<div class="form-group">

							<label for="Votre Nom">Nom contact client</label> <label for="entreprise" class="errorempty"> * </label>
								<div class="input-group">
									
									<input type="text" class="form-control" name="nomontactclient" placeholder="Nom Contact Client"/>
								</div>
						</div>
						<div class="form-group ">
							<label for="entreprise">Télephone contact client</label>
								<div class="input-group">
						...
						<div class="form-group">
			 				<label for="Nom de License">Client</label> <label for="entreprise" class="errorempty"> * </label>
								<div class="input-group">
...
elseif(strpos($fullUrl, "enregistre=char") == true) {
	echo "<h6 class='errorempty'>veuillez remplir Nom Conatct Client Correctement</h6>";
}
...
elseif(strpos($fullUrl, "enregistre=success") == true) {
	...
	echo "<h4 class='success'>Votre Contact Client " . ucwords($_GET['nomontactclient']) . "  Est Bien Enregistre</h4>";
}
